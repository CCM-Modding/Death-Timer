...
public class ServerTimer implements IScheduledTickHandler
{
    ...
    {
        stopwatchList.put(data.getLabel(), data);
        data.sendAutoUpdate();
    }
    ...
    {
        for (final ITimerBase data : timerList.values())
        {
            data.tick();
        ...
        for (final IStopwatchBase data : stopwatchList.values())
        {
            data.tick();
            ...
            if (data.getTime() < 0)
            {
                stopwatchList.remove(data.getLabel());
            }
        }
    }
    ...
    public void save()
    {
        ...
        for (final IStopwatchBase timer : stopwatchList.values())
        {
